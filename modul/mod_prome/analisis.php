...
switch ($_GET[act]) {
    default:
        ...
        $no = 1;
        $tampil = mysqli_query($con, "select * from kandidat where user_id='$userid' LIMIT $posisi,$batas");
...
// Analisa Metode Promee Thee 
    case "analisa-prome":
        ...
        $data = array();
        $sip = mysqli_query($con, "select kriteria1,kriteria2,kriteria3,kriteria4,kriteria5,kriteria6 from kandidat where user_id='$userid'LIMIT $posisi,$batas");
        $no = $posisi + 1;
