...
if (isset($_POST['submit'])) {
    ...
    $query_kriteria_jumlah = mysqli_query($con, "SELECT * FROM kriteria WHERE user_id='$user_id'");
    $num_kriteria = mysqli_num_rows($query_kriteria_jumlah);
    ...
    elseif ($num_kriteria >= 6) echo '<div class="error">Maaf jumlah Kriteria  sudah melebihi batas</div><br>';
        ...
        $query_kriteria_run = mysqli_query($con, "INSERT INTO kriteria (id_kriteria,user_id,nama) VALUES ('$id_kriteria','$user_id','$nama_kriteria')");
...
if ($_GET['act'] == 'del') {
    ...
    $del_query = mysqli_query($con, "DELETE FROM kriteria WHERE id_kriteria='$id_kriteria'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="tabel">
    ...
    <?php
    $i = 1;
    $query_nip = mysqli_query($con, "SELECT * FROM kriteria ");
    ...
    while ($row_nip = mysqli_fetch_object($query_nip)) {
        ...
        <tr>
            ...
            <td align="center">
                <div align="left"><?php echo $row_nip->id_kriteria ?></div>
            </td>
            <td align="center">
                <div align="left"><?php echo $row_nip->nama ?></div>
            </td>
            <td align="center"><a
                        href="?module=datakriteria&amp;act=del&amp;id_kriteria=<?php echo $row_nip->id_kriteria ?>">Hapus</a>
            </td>
        </tr>
        <?php $i++;
    } ?>
