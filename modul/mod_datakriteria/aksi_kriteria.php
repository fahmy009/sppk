...
// }
    ...
    elseif ($module == 'kandidat' AND $act == 'input') {
        mysqli_query($con, "INSERT INTO kandidat(user_id,nip,nama,kriteria1,kriteria2,kriteria3,kriteria4,kriteria5,kriteria6) VALUES('$_POST[user_id]','$_POST[nip]','$_POST[nama]','$_POST[kriteria1]','$_POST[kriteria2]','$_POST[kriteria3]','$_POST[kriteria4]','$_POST[kriteria5]','$_POST[kriteria6]')");
        header('location:../../media.php?module=' . $module);
    }
}
