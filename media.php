        ...
        <ul class="nav">
            <?php if ($_SESSION['leveluser'] == '3') { ?>
                ...
                <li><a class="border link linkback"
                       href="?module=guru&act=detail&id=<?php echo "$_SESSION[namauser]"; ?>">Data Guru</a></li>
                <li><a class="border link linkback"
                       href="?module=guru&act=lihat-nilai&id=<?php echo "$_SESSION[namauser]"; ?>">Lihat Nilai</a>
                </li>
                <li><a href="" class="li"
                       onclick="MM_openBrWindow('laporan_keseluruhan.php','','status=yes,scrollbars=yes,width=1200,height=1000')">Hasil
                        Analisa Metode Promethee</a></li>
            ...
            if ($_SESSION['leveluser'] == '1' or $_SESSION['leveluser'] == '2') {
                ...
                <li><a class="border link linkback" href="#">Laporan</a>
                    <ul>
                        <li><a href="" class="li"
                               onclick="MM_openBrWindow('laporan_pegawai.php','','status=yes,scrollbars=yes,width=980,height=900')">Laporan
                                Data Guru</a></li>

                        <li><a href="" class="li"
                               onclick="MM_openBrWindow('laporan_keseluruhan.php','','status=yes,scrollbars=yes,width=1200,height=1000')">Laporan
                                Data Penilaian</a></li>
                    </ul>
                </li>
                <li><a class="border link linkback" href="logout.php">Logout</a></li>
