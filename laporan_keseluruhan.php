...
switch($_GET['act']){
	...
	$no=1;
	$tampil=mysql_query("select * from kandidat LIMIT $posisi,$batas");
	...
	$data = array();
	$sip=mysql_query("select kriteria1,kriteria2,kriteria3,kriteria4,kriteria5,kriteria6 from kandidat LIMIT $posisi,$batas");$no = $posisi+1;
